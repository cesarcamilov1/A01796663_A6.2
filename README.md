...
Capturas de la ejecución de las pruebas unitarias del proyecto.

![Test](capturas/test.png)

![Test](capturas/test-1.png)

![Test Report](capturas/test-report.png)
...
Capturas de la ejecución de Flake8 en los archivos del proyecto.

### `customer.py`

![Flake8 Customer](capturas/flake-customer.png)

### `hotel.py`

![Flake8 Hotel](capturas/flake-hotel.png)

### `reservation.py`

![Flake8 Reservation](capturas/flake-reservatio.png)

### `test.py`

![Flake8 Test](capturas/flake-tests.png)
